...
(function main() {
  ...
  const outBase = params.outBase || "encounter_without_status_original";
  ...
  const logFileName = params.logFileName || "encounter_without_status_original.log";
  ...
  try {
    ...
    print(JSON.stringify({
      type: "result",
      script: "099_01_03B_esportazione_su_file_encounter_ihub_hc40_adt_without_status_original.js",
      runId, stepId, dbName,
      expDir, outDir,
