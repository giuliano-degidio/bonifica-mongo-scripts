...
(() => {
  ...
  const targetColl = params.targetColl || "bonifica_documentreference_inserted_bck";
  ...
  try {
    ...
    print(JSON.stringify({
      type: "result",
      script: "007_04_rename_collection_documentreference_impacted_modified_to_backup.js",
      runId, stepId, dbName,
