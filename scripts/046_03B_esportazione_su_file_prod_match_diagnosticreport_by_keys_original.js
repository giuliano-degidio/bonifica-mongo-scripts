...
(function main() {
  ...
  const outBase = params.outBase || "diagnosticreport_impacted_original";
  ...
  print(
    JSON.stringify({
      type: "result",
      script: "046_03B_esportazione_su_file_prod_match_diagnosticreport_by_keys_original.js",
      runId,
      stepId,
      dbName,
