...
(() => {
  ...
  const sourceColl = params.sourceColl || "observation_impacted_modified";
  const targetColl = params.targetColl || "bonifica_observation_inserted_bck";
  ...
  try {
    ...
    print(JSON.stringify({
      type: "result",
      script: "027_04_rename_collection_observation_impacted_modified_to_backup.js",
      runId, stepId, dbName,
