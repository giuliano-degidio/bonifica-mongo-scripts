// Same importer as 046_04, just different default prefix/coll
const fs = require("fs");
...
(async () => {
  ...
  const filePrefix = params.filePrefix || "diagnosticreport_impacted_original_chunk";
  const fileSuffix = params.fileSuffix || ".jsonl";
  const maxFiles = params.maxFiles ?? 0;

  const coll = params.collection || "diagnosticreport_impacted_original";
  ...
  print(JSON.stringify({
    type: "result",
    script: "046_04B_importazione_prod_match_diagnosticreport_by_keys_original.js",
    runId, stepId, dbName,
