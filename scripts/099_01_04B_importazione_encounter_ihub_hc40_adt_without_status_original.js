...
(async function main() {
  ...
  const filePrefix = params.filePrefix || "encounter_without_status_original_chunk";
  const fileSuffix = params.fileSuffix || ".jsonl";
  const maxFiles = params.maxFiles ?? 0;

  const coll = params.collection || "encounter_without_status_original";
  ...
  try {
    ...
    print(JSON.stringify({
      type: "result",
      script: "099_01_04B_importazione_encounter_ihub_hc40_adt_without_status_original.js",
      runId, stepId, dbName,
      outDir,
