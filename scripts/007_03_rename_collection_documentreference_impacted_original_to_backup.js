...
(() => {
  ...
  const targetColl = params.targetColl || "bonifica_documentreference_deleted_bck";
  ...
  try {
    ...
    print(JSON.stringify({
      type: "result",
      script: "007_03_rename_collection_documentreference_impacted_original_to_backup.js",
      runId, stepId, dbName,
