...
(() => {
  ...
  const outFileName = params.outFileName || "sio_hc40_adt_keys.js";
  const constName = params.constName || "SIO_HC40_ADT_KEYS";
  ...
  try {
    ...
    print(
      JSON.stringify({
        type: "result",
        script: "006_02b1_esportazione_su_file_sio_to_hc40_adt_map.js",
        runId,
        stepId,
        dbName,
        srcColl,
