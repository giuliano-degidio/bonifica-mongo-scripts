...
(async () => {
  ...
  const sourceColl = params.sourceColl || "observation_impacted_original";
  const historyColl = params.historyColl || "observation_history";
  ...
  const exportFileName = params.exportFileName || "observation_history_inserted_id.js";
  const exportConstName = params.exportConstName || "OBSERVATION_HISTORY_INSERTED_ID";
  ...
  try {
    ...
    print(JSON.stringify({
      type: "result",
      script: "027_01B_insert_observation_history_from_impacted_original.js",
      runId, stepId, dbName,
