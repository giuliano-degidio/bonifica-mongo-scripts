...
(async () => {
  ...
  const sourceColl = params.sourceColl || "documentreference_impacted_modified";
  ...
  try {
    ...
    log(`END: elapsed=${fmtDuration(endMs - startMs)} | TARGET_COLL=${targetColl} | finalTargetCount=${finalCount}`);

    print(JSON.stringify({
      type: "result",
      script: "007_02_insert_documentreference_from_impacted_modified.js",
      runId, stepId, dbName,
      sourceColl, targetColl, mode, batch, logEvery,
