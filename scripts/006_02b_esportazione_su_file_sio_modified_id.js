...
(() => {
  ...
  const outFileName = params.outFileName || "sio_modified_id.js";
  const constName = params.constName || "SIO_MODIFIED_ID";
  ...
  try {
    ...
    print(
      JSON.stringify({
        type: "result",
        script: "006_02b_esportazione_su_file_sio_modified_id.js",
        runId,
        stepId,
        dbName,
        srcColl,
