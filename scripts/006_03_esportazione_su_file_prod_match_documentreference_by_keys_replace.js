...
const DEBUG_DOC_ID = ""; // es: "DocumentReference/bfaf34e0-f860-4f12-9e6a-ec1555996ce1"
...
(function main() {
  ...
  const outBase = params.outBase || "documentreference_impacted";
  ...
  try {
    ...
    for (let chunkIndex = 0; chunkIndex < chunkCount; chunkIndex++) {
      ...
      while (true) {
        ...
        const cursor = db.documentreference
          .find(q)
          .sort({ _id: 1 })
          .limit(batchSize);
  ...
  print(
    JSON.stringify({
      type: "result",
      script: "006_03_esportazione_su_file_prod_match_documentreference_by_keys_replace.js",
      runId,
      stepId,
      dbName,
