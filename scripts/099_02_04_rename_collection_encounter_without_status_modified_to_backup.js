...
(function main() {
  ...
  const targetCollection = params.targetCollection || "bonifica_encounter_without_status_modified_inserted_bck";
  ...
  try {
    ...
    print(JSON.stringify({
      type: "result",
      script: "099_02_04_rename_collection_encounter_without_status_modified_to_backup.js",
      runId, stepId, dbName,
      sourceCollection,
      targetCollection,
      dropTargetIfExists,
