...
(async () => {
  ...
  const exportFileName = params.exportFileName || "documentreference_history_inserted_id.js";
  const exportConstName = params.exportConstName || "DOCUMENTREFERENCE_HISTORY_INSERTED_ID";
  ...
  try {
   // if (!collectionExists(sourceColl)) throw new Error(`Source collection not found: ${sourceColl}`);
    ...
    print(JSON.stringify({
      type: "result",
      script: "007_01B_insert_documentreference_history_from_impacted_original.js",
      runId, stepId, dbName,
