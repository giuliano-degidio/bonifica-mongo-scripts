...
(function main() {
  ...
  const outBase = params.outBase || "observation_impacted_original";
  ...
  try {
    ...
    for (let chunkIndex = 0; chunkIndex < chunkCount; chunkIndex++) {
      ...
      const baseQuery = { attribute_search: { $elemMatch: { name: matchName, value: { $in: sioKeysFullUpper } } } };
    ...
    print(JSON.stringify({
      type: "result",
      script: "026_03B_esportazione_su_file_prod_match_observation_by_keys_original.js",
      runId, stepId, dbName,
