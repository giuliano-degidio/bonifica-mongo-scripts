// Identico a 016_04, cambia solo default prefix/coll
const fs = require("fs");
...
(async () => {
  ...
  const filePrefix = params.filePrefix || "servicerequest_impacted_original_chunk";
  const fileSuffix = params.fileSuffix || ".jsonl";
  const maxFiles = params.maxFiles ?? 0;

  const coll = params.collection || "servicerequest_impacted_original";
  ...
  print(JSON.stringify({
    type: "result",
    script: "016_04B_importazione_prod_match_servicerequest_by_keys_original.js",
    runId, stepId, dbName,
