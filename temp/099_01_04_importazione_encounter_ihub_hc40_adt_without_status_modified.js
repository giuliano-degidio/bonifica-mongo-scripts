...
--quiet ^
--file "C:\Appo09\Mongo_Prod_EXP\099_01_04_importazione_encounter_ihub_hc40_adt_without_status_modified.js"
*/
/* PRODUZIONE/TEST
...
--quiet ^
--file "C:\Appo10\Mongo_Prod_EXP\099_01_04_importazione_encounter_ihub_hc40_adt_without_status_modified.js"
*/
...
/data/mongosh/bin/mongosh "mongodb://root:password@mongo-rs-1.mongo-rs-svc.mongodb.svc.cluster.local:27017/hc40-index-bonifica?authSource=admin&directConnection=true&readPreference=primary" \
  --quiet \
  --file "/data/Mongo_Sh_Script/099_01_04_importazione_encounter_ihub_hc40_adt_without_status_modified.js"

Spostare il file da Windows a Ubuntu Kubernetes:
/*
Get-Content -Raw "C:\Appo10\Mongo_Prod_EXP\099_01_04_importazione_encounter_ihub_hc40_adt_without_status_modified.js" |
kubectl -n ellipse-index exec -i ubuntu-mongosync-6845564564-zvnn9 -- sh -c 'cat > /data/Mongo_Sh_Script/099_01_04_importazione_encounter_ihub_hc40_adt_without_status_modified.js'
*/
/*
log:
[2026-04-23T11:23:03.210Z] START: IN_DIR=C:\Appo10\Mongo_Prod_EXP\EXP | prefix=encounter_without_status_add_chunk | suffix=.jsonl | MAX_FILES=0 | COLL=encounter_without_status_modified | MODE=insert | BATCH=1000 | DROP_BEFORE=true
[2026-04-23T11:23:03.215Z] FILES_FOUND: 1
[2026-04-23T11:23:03.224Z]   - C:\Appo10\Mongo_Prod_EXP\EXP\encounter_without_status_add_chunk0001.jsonl
[2026-04-23T11:23:03.377Z] STEP_DROP_SKIP: encounter_without_status_modified does not exist | elapsed=0h 0m 0s
[2026-04-23T11:23:03.380Z] FILE_START [1/1]: C:\Appo10\Mongo_Prod_EXP\EXP\encounter_without_status_add_chunk0001.jsonl
[2026-04-23T11:23:05.020Z] BULK_END file[1/1] #1: ops=19 inserted=19 upserted=0 modified=0 | elapsed=0h 0m 1s
[2026-04-23T11:23:05.020Z] FILE_END [1/1]: lines=19 emptyLines=0 parsedDocs=19 bulks=1 opsExecuted=19 inserted=19 upserted=0 modified=0 | elapsed=0h 0m 1s
[2026-04-23T11:23:05.021Z] STEP_IMPORT_ALL_END: elapsed=0h 0m 1s
[2026-04-23T11:23:05.074Z] TOTALS: files=1 lines=19 emptyLines=0 parsedDocs=19 bulks=1 opsExecuted=19 inserted=19 upserted=0 modified=0 finalCollCount=19
[2026-04-23T11:23:05.074Z] END: elapsed=0h 0m 1s | COLL=encounter_without_status_modified | finalCollCount=19
*/

// Importa i file JSONL prodotti dallo step 099_01_03 (encounter_without_status_add_chunk0001, ...)
// nella collezione encounter_without_status_modified, in upsert o insert.
//
// NOTE IMPORTANTI:
// - MODE="upsert" è la modalità consigliata per rendere lo script ri-eseguibile senza duplicati.
// - DROP_BEFORE=true droppa la collezione UNA SOLA VOLTA all'inizio, poi importa tutti i file.

const fs = require("fs");
const readline = require("readline");
const path = require("path");

// Directory + pattern dei file prodotti dal precedente
//const IN_DIR = "/data/Mongo_Sh_Script/EXP";
// Windows example:
const IN_DIR = "C:\\Appo10\\Mongo_Prod_EXP\\EXP";
const FILE_PREFIX = "encounter_without_status_add_chunk";
const FILE_SUFFIX = ".jsonl";

// Se vuoi limitare il numero di file importati (0 = tutti)
const MAX_FILES = 0;

// Collezione target
const COLL = "encounter_without_status_modified";

// Modalità:
// - "upsert" : evita duplicati, ri-eseguibile
// - "insert" : inserimento puro
const MODE = "insert";

// Batch size bulkWrite
const BATCH = 1000;

// per ricreare la collezione prima dell’import impostare a true:
const DROP_BEFORE = true;

// log di progresso anche durante la lettura (ogni N righe lette)
